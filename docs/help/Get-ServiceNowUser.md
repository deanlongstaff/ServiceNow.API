...
```
Get-ServiceNowUser [-ProgressAction <ActionPreference>] [-Sys_ID <String>] [-Query <String>]
...
## DESCRIPTION
A convenience wrapper around Get-ServiceNowRecord for the 'sys_user' table.
It accepts all the
same filtering, field selection, sorting, pagination and connection parameters.
Look users up

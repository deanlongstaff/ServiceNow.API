...
```
New-ServiceNowIncident [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] -InputData <Hashtable>
 [-InputDisplayValue] [-PassThru] [-Instance <String>] [-Connection <Hashtable>] [<CommonParameters>]
```

## DESCRIPTION
A convenience wrapper around New-ServiceNowRecord for the 'incident' table.
It accepts the same

...
```
Get-ServiceNowChangeRequest [[-Number] <String>] [-ProgressAction <ActionPreference>] [-Sys_ID <String>]
...
## DESCRIPTION
A convenience wrapper around Get-ServiceNowRecord for the 'change_request' table.
It accepts

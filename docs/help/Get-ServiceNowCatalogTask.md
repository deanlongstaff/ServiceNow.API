...
```
Get-ServiceNowCatalogTask [[-Number] <String>] [-ProgressAction <ActionPreference>] [-Sys_ID <String>]
...
## DESCRIPTION
A convenience wrapper around Get-ServiceNowRecord for the 'sc_task' table.
It accepts all the

...
```
Get-ServiceNowIncident [[-Number] <String>] [-ProgressAction <ActionPreference>] [-Sys_ID <String>]
...
to remember the table name.
It accepts all the same filtering, field selection, sorting,

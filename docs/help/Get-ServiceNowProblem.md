...
```
Get-ServiceNowProblem [[-Number] <String>] [-ProgressAction <ActionPreference>] [-Sys_ID <String>]
...
## DESCRIPTION
A convenience wrapper around Get-ServiceNowRecord for the 'problem' table.
It accepts all the
